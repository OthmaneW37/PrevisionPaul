...
Le projet relève directement de l'intelligence artificielle appliquée à la
prévision. Il automatise l'apprentissage de régularités temporelles, compare
plusieurs modèles, sélectionne la méthode la plus adaptée à chaque produit et
utilise un modèle global d'apprentissage automatique pour mutualiser
l'information entre références. L'IA n'est donc pas un habillage du tableau de
bord : elle constitue le moteur qui transforme l'historique en recommandations
explicables et mesurées hors échantillon.
