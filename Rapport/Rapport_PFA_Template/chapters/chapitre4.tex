...
financiers existent dans l'application interne ; leurs montants sont recouverts
par un aplat noir dans la figure~\ref{fig:ui-accueil}.

\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{paul_accueil.png}
\caption{Page d'accueil -- montant de chiffre d'affaires censuré}
...
\caption{Vue MRP -- budget et ratios financiers censurés}
\label{fig:ui-mrp}
\end{figure}
...
\caption{Analyse financière -- montants confidentiels censurés}
...
\caption{Validation mensuelle -- panneau de chiffre d'affaires censuré}
