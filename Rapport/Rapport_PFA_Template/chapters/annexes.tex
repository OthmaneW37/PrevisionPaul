...
Les panneaux financiers sont recouverts en noir dans les captures publiques. Les
graphiques de quantités, les nombres de produits et la répartition par familles
restent visibles, car ces éléments ne sont pas confidentiels.

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{dashboard_gerant.png}
\caption{Dashboard statique du responsable -- panneaux financiers censurés}
...
\caption{Dashboard statique des matières premières -- quantités non confidentielles}
