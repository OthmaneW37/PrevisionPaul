...
\begin{attentionbox}
Les dashboards statiques destinés au responsable et aux achats contiennent des
montants de chiffre d'affaires, de budget, de prix et de marges. Ils ne sont pas
reproduits dans l'annexe publique. Les graphiques de quantités, les nombres de
produits et la répartition des modèles restent documentés dans le corps du
rapport, car ces éléments ne sont pas confidentiels.
\end{attentionbox}
