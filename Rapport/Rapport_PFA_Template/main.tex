...
\hypersetup{
  pdftitle={PrevisionPaul — Prévision des ventes et planification des approvisionnements},
...
% -----------------------------------------------------------------------------
\newcommand{\TitreRapport}{Conception et développement d'un système de prévision des ventes et de planification des approvisionnements pour PAUL Maroc}
\newcommand{\NomProjet}{PrevisionPaul}
\newcommand{\AuteurRapport}{Othmane Moussawi}
\newcommand{\EncadrantProfessionnel}{\textit{À compléter}}
\newcommand{\EncadrantPedagogique}{\textit{À compléter}}
...
\begin{titlepage}
  ...
  \begin{minipage}{0.62\textwidth}
    \centering\includegraphics[width=0.82\linewidth]{logo-emsi.png}
  \end{minipage}\hfill
  \begin{minipage}{0.25\textwidth}
    \centering\includegraphics[width=0.95\linewidth]{Logo_Paul.png}
  \end{minipage}
...
d'approvisionnement. La solution exploite 373,875 lignes de ventes journalières
...
\textbf{Mots-clés :} prévision des ventes, séries temporelles, planification de
production, MRP, nomenclature, Dash, validation glissante, boulangerie.
...
into production and purchasing decisions. The solution processes 373,875 daily
...
\textbf{Keywords:} sales forecasting, time series, production planning, MRP,
bill of materials, Dash, walk-forward validation, bakery.
